(() => {
  ...
  const DreamApp = () => {
    ...
    ))))), /* @__PURE__ */ React.createElement("section", { className: "defer-section py-16 md:py-24", style: { background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-[1fr_auto] gap-10 md:gap-16 items-center" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "Research / Beta Program")), /* @__PURE__ */ React.createElement(Reveal, { y: 32, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-5", style: { fontSize: "clamp(2.6rem,5.5vw,4.4rem)", lineHeight: 0.88, letterSpacing: "-0.055em", textTransform: "uppercase", color: "var(--ink)" } }, "Help us build", /* @__PURE__ */ React.createElement("br", null), "the right tool.")), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.16 }, /* @__PURE__ */ React.createElement("p", { className: "mt-5 leading-relaxed", style: { color: "rgba(9,9,9,0.62)", maxWidth: "34rem", fontSize: "1.02rem" } }, "We're running a brief research study with residential architects and designers. Your responses directly shape Keystone's feature roadmap and pricing model.")), /* @__PURE__ */ React.createElement(Reveal, { y: 12, delay: 0.24 }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-6" }, ["Pain points in intake", "Tool evaluation habits", "Pricing sensitivity", "Beta access"].map((chip) => /* @__PURE__ */ React.createElement("span", { key: chip, className: "survey-theme-chip" }, chip)))), /* @__PURE__ */ React.createElement(Reveal, { y: 12, delay: 0.32 }, /* @__PURE__ */ React.createElement("div", { className: "mt-8 grid sm:grid-cols-3 gap-4" }, [{ val: "~3 min", lbl: "to complete" }, { val: "10", lbl: "focused questions" }, { val: "100%", lbl: "anonymous" }].map((item) => /* @__PURE__ */ React.createElement("div", { key: item.lbl, className: "paper-panel p-5" }, /* @__PURE__ */ React.createElement("div", { className: "cg", style: { fontSize: "2.1rem", color: "var(--accent)", letterSpacing: "-0.04em", lineHeight: 1 } }, item.val), /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em] mt-2", style: { color: "rgba(9,9,9,0.48)" } }, item.lbl)))))), /* @__PURE__ */ React.createElement(Reveal, { y: 28, delay: 0.18 }, /* @__PURE__ */ React.createElement("div", { className: "survey-qr-frame", style: { minWidth: "220px", maxWidth: "280px" } }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.26em]", style: { color: "rgba(9,9,9,0.38)" } }, "Scan to participate"), /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "mt-4 rounded-[16px] overflow-hidden mx-auto",
