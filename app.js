  ...
  const pricingTiers = [
    {
      tag: "Guided demo",
      price: "$0",
      unit: "requires approval",
      desc: "A guided walkthrough of the firm workflow so your team can see the client link, plan generation, export path, and Gemini study together. Submit a brief request — we schedule within a few days.",
      cta: "Request Access",
      featured: false
    },
    {
      ...
      desc: "A complete Keystone session for one active lead, from client brief capture through architect-ready plan export and optional Gemini study. Pay once, keep the outputs forever.",
