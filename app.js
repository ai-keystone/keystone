...
const BrandLockup = ({
  ...
  const content = /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-3 ${className}` }, /* @__PURE__ */ React.createElement(
    SmartImage,
    {
      src: ASSETS.logoMark,
  ...
  ), !markOnly && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    "span",
    {
  ...
  return /* @__PURE__ */ React.createElement("a", { href, onClick }, content);
};
...
const LaserCursor = () => {
  ...
  useEffect(() => {
    ...
    sync();
    (_a = finePointer.addEventListener) == null ? void 0 : _a.call(finePointer, "change", sync);
    (_b = reducedMotion.addEventListener) == null ? void 0 : _b.call(reducedMotion, "change", sync);
    return () => {
      var _a2, _b2;
      (_a2 = finePointer.removeEventListener) == null ? void 0 : _a2.call(finePointer, "change", sync);
      (_b2 = reducedMotion.removeEventListener) == null ? void 0 : _b2.call(reducedMotion, "change", sync);
    };
  }, []);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const setHoverLabel = (target) => {
      const next = (target == null ? void 0 : target.getAttribute("data-cursor-text")) || "";
...
const SpotlightCard = ({ children, className = "", spotlightColor = "rgba(255,106,55,0.15)", style = {} }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref, onMouseMove: handleMove, className: `spotlight-card ${className}`, style }, children);
};
...
const BlurText = ({ text = "", delay = 65, className = "", direction = "bottom", tag: Tag = "span", style = {} }) => {
  ...
  return /* @__PURE__ */ React.createElement(Tag, { ref, className: `blur-text-wrap ${className}`, style }, words.map((word, i) => /* @__PURE__ */ React.createElement(
    motion.span,
    {
      key: i,
      className: "blur-word",
      ...
      transition: { duration: 0.58, delay: i * (delay / 1e3), ease: [0.22, 1, 0.36, 1] }
    },
    word
  )));
};
const GradientText = ({ children, className = "" }) => /* @__PURE__ */ React.createElement("span", { className: `gradient-text-anim ${className}` }, children);
const StarBorderBtn = ({ children, onClick, className = "" }) => /* @__PURE__ */ React.createElement("div", { className: `star-border-wrap ${className}` }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick, className: "cta-hero cta-glow cta-live", style: { position: "relative", zIndex: 1 } }, children));
const OrbBackground = () => /* @__PURE__ */ React.createElement("div", { className: "orb-bg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("div", { className: "orb orb-1" }), /* @__PURE__ */ React.createElement("div", { className: "orb orb-2" }), /* @__PURE__ */ React.createElement("div", { className: "orb orb-3" }));
const FloatingParticles = ({ count = 55, color = "255,106,55", className = "" }) => {
  ...
  return /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, className: `particle-canvas ${className}` });
};
const CountUp = ({ to, duration = 1600, suffix = "", className = "" }) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { ref, className }, n, suffix);
};
const SplashCursor = ({
  SIM_RESOLUTION = 32,
  DYE_RESOLUTION = 1440,
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas2) {
      ...
      const isWebGL2 = !!gl2;
      if (!isWebGL2) gl2 = canvas2.getContext("webgl", params) || canvas2.getContext("experimental-webgl", params);
      ...
      return { gl: gl2, ext: { formatRGBA, formatRG, formatR, halfFloatTexType, supportLinearFiltering } };
    }
    ...
    function getUniforms(program) {
      let u = [], n = gl.getProgramParameter(program, gl.ACTIVE_UNIFORMS);
      for (let i = 0; i < n; i++) {
...
gl_FragColor=result/(1.0+dissipation*dt);}`, ext.supportLinearFiltering ? null : ["MANUAL_FILTERING"]);
    ...
    function createFBO(w, h, internalFormat, format, type, param) {
      ...
      gl.viewport(0, 0, w, h);
      gl.clear(gl.COLOR_BUFFER_BIT);
      return { texture: tex, fbo, width: w, height: h, texelSizeX: 1 / w, texelSizeY: 1 / h, attach(id) {
    ...
    function createDoubleFBO(w, h, internalFormat, format, type, param) {
      ...
      return { width: w, height: h, texelSizeX: fbo1.texelSizeX, texelSizeY: fbo1.texelSizeY, get read() {
        return fbo1;
      }, set read(v) {
        fbo1 = v;
      }, get write() {
    ...
    function frame() {
      if (!isActive) return;
      const now = Date.now();
      let dt = Math.min((now - lastTime) / 1e3, 0.016666);
      lastTime = now;
    ...
    function resizeCanvas() {
      let w = scaleByDPR(canvas.clientWidth), h = scaleByDPR(canvas.clientHeight);
    ...
    function genColor() {
      ...
      const { r, g, b } = HSVtoRGB(hue, 0.85 + Math.random() * 0.15, 1);
    ...
    function handleMouseDown(e) {
      let p = pointers[0];
      let px = scaleByDPR(e.clientX), py = scaleByDPR(e.clientY);
      downPtr(p, -1, px, py);
      clickSplat(p);
    }
    ...
    function handleTouchStart(e) {
      ...
      for (let i = 0; i < touches.length; i++) {
        let px = scaleByDPR(touches[i].clientX), py = scaleByDPR(touches[i].clientY);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, zIndex: 50, pointerEvents: "none", width: "100%", height: "100%" }, "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, style: { width: "100%", height: "100%" } }));
};
const Waves = ({
  ...
  useEffect(() => {
    ...
    function setLines() {
      linesRef.current = [];
      const { width, height } = bounding, { xGap: xGap2, yGap: yGap2 } = configRef.current;
      const oW = width + 200, oH = height + 30;
      const tL = Math.ceil(oW / xGap2), tP = Math.ceil(oH / yGap2);
      const xStart = (width - xGap2 * tL) / 2, yStart = (height - yGap2 * tP) / 2;
      for (let i = 0; i <= tL; i++) {
        const pts = [];
        for (let j = 0; j <= tP; j++) {
          pts.push({ x: xStart + xGap2 * i, y: yStart + yGap2 * j, wave: { x: 0, y: 0 }, cursor: { x: 0, y: 0, vx: 0, vy: 0 } });
        }
    ...
    function movePoints(time) {
      ...
      linesRef.current.forEach((pts) => {
        pts.forEach((p) => {
          const move = perlin2((p.x + time * waveSpeedX2) * 2e-3, (p.y + time * waveSpeedY2) * 15e-4) * 12;
    ...
    function onMouseMove(e) {
      const mouse = mouseRef.current, b = bounding;
    ...
    function onTouchMove(e) {
      const t = e.touches[0], mouse = mouseRef.current, b = bounding;
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className, style: { position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none", ...style }, "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, className: "waves-canvas" }));
};
...
const BentoParticleCard = ({ children, className = "", style, particleCount = 10, glowColor = "255,106,55", clickEffect = true }) => {
  ...
  const clearParticles = () => {
    ...
    particlesRef.current.forEach((p) => {
      ...
      gsap.to(p, { scale: 0, opacity: 0, duration: 0.3, ease: "back.in(1.7)", onComplete: () => {
        var _a;
        return (_a = p.parentNode) == null ? void 0 : _a.removeChild(p);
      } });
    });
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: cardRef, className: `${className} particle-container`, style: { ...style, position: "relative", overflow: "hidden" } }, children);
};
const BentoGlobalSpotlight = ({ gridRef, spotlightRadius = 400, glowColor = "255,106,55" }) => {
  const spotRef = useRef(null);
  useEffect(() => {
    if (!(gridRef == null ? void 0 : gridRef.current)) return;
    const gsap = window.gsap;
    ...
    const onMove = (e) => {
      ...
      if (!inside) {
        if (gsap) gsap.to(spotlight, { opacity: 0, duration: 0.3 });
      ...
      if (gsap) {
        ...
        gsap.to(spotlight, { opacity: op, duration: 0.2, ease: "power2.out" });
      } else {
    ...
    const onLeave = () => {
      var _a;
      (_a = gridRef.current) == null ? void 0 : _a.querySelectorAll(".magic-bento-card").forEach((c) => c.style.setProperty("--glow-intensity", "0"));
      if (gsap) gsap.to(spotlight, { opacity: 0, duration: 0.3 });
      else spotlight.style.opacity = "0";
    };
    ...
    return () => {
      ...
      (_a = spotlight.parentNode) == null ? void 0 : _a.removeChild(spotlight);
    };
...
const MagicBento = ({ cards = keystoneBentoCards, glowColor = "255,106,55", spotlightRadius = 400, particleCount = 10, clickEffect = true }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, !isMobile && /* @__PURE__ */ React.createElement(BentoGlobalSpotlight, { gridRef, spotlightRadius, glowColor }), /* @__PURE__ */ React.createElement("div", { className: "card-grid bento-section", ref: gridRef }, cards.map((card, i) => /* @__PURE__ */ React.createElement(
    BentoParticleCard,
    {
      key: i,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "magic-bento-card__header" }, /* @__PURE__ */ React.createElement("div", { className: "magic-bento-card__label" }, card.label)),
    card.svgHtml && /* @__PURE__ */ React.createElement("div", { className: "magic-bento-card__graphic", dangerouslySetInnerHTML: { __html: card.svgHtml } }),
    /* @__PURE__ */ React.createElement("div", { className: "magic-bento-card__content" }, /* @__PURE__ */ React.createElement("h2", { className: "magic-bento-card__title" }, card.title), /* @__PURE__ */ React.createElement("p", { className: "magic-bento-card__description" }, card.description))
  ))));
};
...
const MobileMenuOverlay = ({ isOpen, onClose, onJoin }) => /* @__PURE__ */ React.createElement(AnimatePresence, null, isOpen && /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center px-6 py-5 border-b border-white/8" }, /* @__PURE__ */ React.createElement(BrandLockup, { href: "/", reverse: true, compact: true, onClick: onClose }), /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "w-9 h-9 bg-white/10 rounded-full flex items-center justify-center" }, /* @__PURE__ */ React.createElement("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" })))),
  /* @__PURE__ */ React.createElement("div", { className: "flex-1 px-6 py-6 flex flex-col gap-0" }, [["Platform", "work"], ["Services", "services"], ["Pricing", "pricing"], ["Live Studio", "generator"], ["Studio", "studio"], ["Sessions", "gallery"]].map(([label, id], i) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: id,
      onClick: () => {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2 mt-5" }, /* @__PURE__ */ React.createElement("a", { href: "/how-floor-plans-work", className: "mono text-[10px] uppercase tracking-[0.22em] px-4 py-3 rounded-full border border-white/10 text-center text-white/70 hover:text-white hover:border-white/24 transition-colors" }, "How It Works"), /* @__PURE__ */ React.createElement("a", { href: "/b2b-workflow", className: "mono text-[10px] uppercase tracking-[0.22em] px-4 py-3 rounded-full border border-white/10 text-center text-white/70 hover:text-white hover:border-white/24 transition-colors" }, "B2B Workflow"), /* @__PURE__ */ React.createElement("a", { href: "/roadmap", className: "mono text-[10px] uppercase tracking-[0.22em] px-4 py-3 rounded-full border border-white/10 text-center text-white/70 hover:text-white hover:border-white/24 transition-colors" }, "Roadmap"), /* @__PURE__ */ React.createElement("a", { href: "/faq", className: "mono text-[10px] uppercase tracking-[0.22em] px-4 py-3 rounded-full border border-white/10 text-center text-white/70 hover:text-white hover:border-white/24 transition-colors" }, "FAQ")), /* @__PURE__ */ React.createElement("div", { className: "mt-auto pt-8 grid gap-3" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        scrollTo("generator");
...
const ElevationsPanel = ({ elevations, formData, onOpenPreview }) => {
  ...
  const defaultKey = `${((_a = elevations == null ? void 0 : elevations.meta) == null ? void 0 : _a.supportViewKey) || "front"}Svg`;
  const [activeKey, setActiveKey] = React.useState(availableViews.some((view) => view.key === "frontSvg") ? "frontSvg" : ((_b = availableViews[0]) == null ? void 0 : _b.key) || null);
  React.useEffect(() => {
    var _a2;
    const nextKey = availableViews.some((view) => view.key === "frontSvg") ? "frontSvg" : ((_a2 = availableViews[0]) == null ? void 0 : _a2.key) || defaultKey || null;
  ...
  const activeSvg = (elevations == null ? void 0 : elevations[activeView == null ? void 0 : activeView.key]) || "";
  const activeSrc = svgMarkupToDataUri(activeSvg);
  const styleLabel = ((_c = elevations == null ? void 0 : elevations.meta) == null ? void 0 : _c.styleLabel) || (formData == null ? void 0 : formData.materials) || "Residential";
  const roofKind = String(((_d = elevations == null ? void 0 : elevations.meta) == null ? void 0 : _d.roofKind) || "gabled").replace(/_/g, " ");
  const supportLabel = ((_e = elevations == null ? void 0 : elevations.meta) == null ? void 0 : _e.supportViewKey) ? `${elevations.meta.supportViewKey} elevation` : "side elevation";
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "paper-panel" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 border-b border-black/5 bg-white/40 flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "Elevations"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] leading-relaxed mt-2", style: { color: "rgba(10,10,12,0.62)" } }, "Deterministic facade views derived from the plan geometry, vertical model, and survey style.")), /* @__PURE__ */ React.createElement("div", { className: "mono text-[8px] uppercase tracking-[0.22em] text-right", style: { color: "rgba(10,10,12,0.46)" } }, styleLabel, /* @__PURE__ */ React.createElement("br", null), roofKind)), /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "rounded-[18px] border border-black/8 bg-white overflow-hidden shadow-sm" }, activeSrc ? /* @__PURE__ */ React.createElement(
    "img",
    {
      src: activeSrc,
  ...
  ) : /* @__PURE__ */ React.createElement("div", { className: "p-8 text-center text-mid text-[11px]" }, "Elevation preview unavailable.")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2 mt-3" }, availableViews.map((view) => {
    const selected = (activeView == null ? void 0 : activeView.key) === view.key;
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        key: view.key,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mono text-[8px] uppercase tracking-[0.18em]", style: { color: selected ? "rgba(27,79,130,0.92)" : "rgba(10,10,12,0.52)" } }, view.label, " view"),
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] mt-1", style: { color: "rgba(10,10,12,0.72)" } }, view.key === "frontSvg" ? "Primary street-facing facade" : view.key === "rearSvg" ? "Rear massing and glazing" : view.key === "leftSvg" ? "Left-side profile" : "Right-side profile")
    );
  })), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mt-3 flex-wrap" }, /* @__PURE__ */ React.createElement("button", { onClick: downloadActive, className: "mono text-[9px] text-blue underline" }, "Download active view"), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] uppercase tracking-[0.18em]", style: { color: "rgba(10,10,12,0.42)" } }, supportLabel, " is also used to ground the 3D exterior study."))));
};
...
const RefinementPanel = ({ planSpec, formData, refinementsLeft, refinementHistory, onRefine, isLoading }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "border-t border-black/8" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-4 md:px-5 pt-4 pb-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { style: { width: "6px", height: "6px", borderRadius: "50%", background: "var(--accent)", display: "inline-block" } }), /* @__PURE__ */ React.createElement("p", { className: "mono text-[8px] uppercase tracking-[0.24em] font-bold", style: { color: "rgba(10,10,12,0.62)" } }, "Studio notes")), /* @__PURE__ */ React.createElement("span", { className: "mono text-[9px] font-bold", style: { color: countColor } }, refinementsLeft, "/10 edits left")), /* @__PURE__ */ React.createElement("div", { className: "px-4 md:px-5 pb-3" }, /* @__PURE__ */ React.createElement("p", { className: "text-[12px] leading-relaxed", style: { color: "rgba(10,10,12,0.62)" } }, "Use quick edits to explore the floor plan before you export it or move into the Gemini exterior study.")), refinementHistory.length > 0 && /* @__PURE__ */ React.createElement(
    "div",
    {
      ref: historyRef,
    ...
    refinementHistory.map((msg, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "px-3 py-2.5 border-b last:border-0", style: { borderColor: "rgba(10,10,12,0.06)" } }, msg.role === "user" && /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 items-start" }, /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] uppercase pt-0.5 flex-shrink-0 font-bold", style: { color: "rgba(173,51,0,0.92)" } }, "You"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] leading-snug", style: { color: "rgba(10,10,12,0.82)" } }, msg.content)), msg.role === "assistant" && /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 items-start" }, /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] uppercase pt-0.5 flex-shrink-0 font-bold", style: { color: "rgba(10,10,12,0.42)" } }, "Studio"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] leading-snug", style: { color: "rgba(27,79,130,0.92)" } }, "Updated: ", msg.content)), msg.role === "error" && /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 items-start" }, /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] uppercase pt-0.5 flex-shrink-0 font-bold", style: { color: "rgba(255,133,119,0.92)" } }, "Error"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] leading-snug", style: { color: "rgba(255,178,164,0.92)" } }, msg.content)))),
    isLoading && /* @__PURE__ */ React.createElement("div", { className: "px-3 py-2 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "w-3 h-3 border-2 border-blue border-t-transparent rounded-full animate-spin flex-shrink-0" }), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] uppercase tracking-widest animate-pulse", style: { color: "rgba(10,10,12,0.46)" } }, "Updating the plan..."))
  ), isLoading && refinementHistory.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "mx-4 md:mx-5 mb-3 px-3 py-2 flex items-center gap-2 rounded-[14px]", style: { background: "rgba(255,255,255,0.82)", border: "1px solid rgba(10,10,12,0.08)" } }, /* @__PURE__ */ React.createElement("div", { className: "w-3 h-3 border-2 border-blue border-t-transparent rounded-full animate-spin flex-shrink-0" }), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] uppercase tracking-widest animate-pulse", style: { color: "rgba(10,10,12,0.46)" } }, "Updating the plan...")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 px-4 md:px-5 mb-3" }, REFINEMENT_SUGGESTIONS.map((s, i) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: i,
      disabled,
...
const planSpanForElevation = (planSpec, viewKey) => {
  var _a, _b, _c;
  const level1 = ((planSpec == null ? void 0 : planSpec.levels) || []).find((level) => Number((level == null ? void 0 : level.level) || 1) === 1) || ((planSpec == null ? void 0 : planSpec.levels) || [])[0];
  if (!level1) return 30;
  const frontEdge = ((_b = (_a = planSpec == null ? void 0 : planSpec.elevations) == null ? void 0 : _a.meta) == null ? void 0 : _b.frontEdge) || ((_c = planSpec == null ? void 0 : planSpec.facade) == null ? void 0 : _c.frontEdge) || "bottom";
...
0`);
  ...
  const drawTitleBlock = (x, y, w, h) => {
    ...
    drawText(x + 1, y + h - 0.55, 0.55, `Generated ${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}`, "LABELS");
    drawText(x + w * 0.55 + 0.8, y + h - 2.8, 0.7, `STYLE: ${String(((_b = (_a = planSpec == null ? void 0 : planSpec.elevations) == null ? void 0 : _a.meta) == null ? void 0 : _b.styleLabel) || "Residential").toUpperCase()}`, "LABELS");
    drawText(x + w * 0.55 + 0.8, y + h - 1.7, 0.7, `FRONT: ${String(((_c = planSpec == null ? void 0 : planSpec.surveyData) == null ? void 0 : _c.frontFacing) || "South").toUpperCase()}`, "LABELS");
    drawText(x + w * 0.55 + 0.8, y + h - 0.6, 0.55, "Includes plans, dimensions, furniture, and elevations", "LABELS");
  };
  const roomParts = (room) => Array.isArray(room == null ? void 0 : room.parts) && room.parts.length ? room.parts : [room];
  ...
  const collectExteriorBreaks = (level, axis) => {
    ...
    const values = /* @__PURE__ */ new Set([0, max]);
  ...
  const drawDoorSymbol = (door, level, originX, originY) => {
    ...
    const isPrivate = (room) => /bedroom|bathroom|study|office|garage|library|gym/i.test(String((room == null ? void 0 : room.type) || ""));
    ...
    if (door.dir === "vertical") {
      ...
      const centerA2 = roomA ? Number(roomA.x || 0) + Number(roomA.w || 0) / 2 : 0;
      const centerB2 = roomB ? Number(roomB.x || 0) + Number(roomB.w || 0) / 2 : 0;
      const swingRight = preferIntoB ? centerB2 > Number(door.x || 0) : preferIntoA ? centerA2 > Number(door.x || 0) : centerB2 >= centerA2;
      const hingeX2 = dx;
      const hingeY2 = yTop;
      const leafX = swingRight ? dx + dw : dx - dw;
      drawLine(hingeX2, hingeY2, leafX, hingeY2, "DOORS");
      if (swingRight) drawArc(hingeX2, hingeY2, dw, 270, 360, "DOORS");
      else drawArc(hingeX2, hingeY2, dw, 180, 270, "DOORS");
  ...
  const drawElevationSvg = (svgMarkup, label, originX, originY, targetWidthFt, dimensionLabel) => {
    ...
    const viewBox = String(root2.getAttribute("viewBox") || "").trim().split(/\s+/).map(Number);
    const vbX = viewBox.length === 4 ? viewBox[0] : 0;
    const vbY = viewBox.length === 4 ? viewBox[1] : 0;
    const vbW = viewBox.length === 4 ? viewBox[2] : svgAttrNumber(root2.getAttribute("width"), 940);
    const vbH = viewBox.length === 4 ? viewBox[3] : svgAttrNumber(root2.getAttribute("height"), 480);
    ...
    root2.querySelectorAll("line,rect,circle,path,text,polygon,polyline").forEach((node) => {
  ...
  const elevations = (planSpec == null ? void 0 : planSpec.elevations) || {};
...
const SurveyForm = ({ formData, setFormData, onSubmit, isLoading, onReset }) => {
  ...
  const renderField = (field) => {
    ...
    switch (field) {
      ...
      case "privateBaths": {
        const bedLabels = bedCount <= 1 ? ["Primary Bedroom"] : ["Primary Bedroom", ...Array.from({ length: bedCount - 1 }, (_, i) => `Bedroom ${i + 2}`)];
        ...
        return /* @__PURE__ */ React.createElement("div", { key: field, className: "space-y-3 p-3 bg-blue/4 border border-blue/15 rounded-sm" }, /* @__PURE__ */ React.createElement(Lbl, null, "Bedroom Configuration"), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-mid mb-1" }, "Set private bathroom and closet type for each bedroom."), bedLabels.map((label, idx) => {
          const cfg = (formData.bedroomConfigs || configs)[idx] || { privateBath: idx === 0 ? "Yes" : "No", closet: idx === 0 ? "Walk-in" : "Standard" };
          return /* @__PURE__ */ React.createElement("div", { key: idx, className: "p-2.5 bg-white/60 border border-black/5 rounded-sm space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold uppercase tracking-wider", style: { color: "var(--blue)" } }, label), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 items-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-medium text-mid w-16 shrink-0" }, "En-Suite"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 flex-1" }, ["Yes", "No"].map((v) => {
            const sel = cfg.privateBath === v;
            return /* @__PURE__ */ React.createElement("button", { key: v, type: "button", "aria-pressed": sel, onClick: () => {
              ensureConfigs();
              updateConfig(idx, "privateBath", v);
            }, className: "flex-1 h-8 border text-[10px] font-bold rounded-sm", style: choiceStyle(sel, "blue") }, v);
          }))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 items-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-medium text-mid w-16 shrink-0" }, "Closet"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 flex-1" }, ["Walk-in", "Standard"].map((v) => {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "gallery", ref: sectionRef, style: { background: "linear-gradient(180deg, #FFFDFC 0%, #F5F0E9 100%)", padding: "4.5rem 0 5.5rem" } }, /* @__PURE__ */ React.createElement(AnimatePresence, null, zoomImg && /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-5 md:p-7" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between mb-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "badge" }, "Generated Plan"), /* @__PURE__ */ React.createElement("h3", { className: "cg italic text-2xl mt-2" }, selected.label || "Floor Plan"), /* @__PURE__ */ React.createElement("p", { className: "mono text-[8px] uppercase tracking-widest text-mid mt-1" }, fmt(selected.createdAt))), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setSelected(null), "aria-label": "Close session detail", className: "w-9 h-9 bg-black/6 rounded-full flex items-center justify-center hover:bg-black/12 transition-colors flex-shrink-0" }, /* @__PURE__ */ React.createElement(CloseIcon, { className: "w-4 h-4" }))), /* @__PURE__ */ React.createElement("div", { className: "gallery-detail-grid" }, /* @__PURE__ */ React.createElement(
        ...
        ["Area", ((_a = selected.planSpec) == null ? void 0 : _a.totalAreaSqFt) ? `${selected.planSpec.totalAreaSqFt.toLocaleString()} sqft` : "-"],
...
const InteractiveCanvas = ({ children }) => {
  ...
  const toolbarBtn = (onClick, title, content, active) => /* @__PURE__ */ React.createElement("button", { onClick, title, style: {
    width: 28,
    height: 28,
    display: "flex",
    alignItems: "center",
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: {
      ...
      "Zoom Out",
      /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M20 12H4" }))
    ), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 8, color: "rgba(244,239,230,0.4)", letterSpacing: "0.1em", minWidth: 34, textAlign: "center" } }, Math.round(scale * 100), "%"), toolbarBtn(
      (e) => {
        e.stopPropagation();
        setScale((s) => Math.min(s * 1.25, 5));
      },
      "Zoom In",
      /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 4v16m8-8H4" }))
    ), /* @__PURE__ */ React.createElement("div", { style: { width: 1, height: 16, background: "rgba(255,255,255,0.12)", margin: "0 2px" } }), toolbarBtn(
      (e) => {
        e.stopPropagation();
        resetView();
      },
      "Fit to View",
      /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" }))
    ), /* @__PURE__ */ React.createElement("div", { style: { width: 1, height: 16, background: "rgba(255,255,255,0.12)", margin: "0 2px" } }), toolbarBtn(
      (e) => {
        e.stopPropagation();
        setBlueprintMode((m) => !m);
      },
      blueprintMode ? "White Mode" : "Blueprint Mode",
      /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" })),
      blueprintMode
    )),
    /* @__PURE__ */ React.createElement("div", { style: {
      position: "absolute",
...
const DesignGenerator = ({ onOpenModal }) => {
  ...
  useEffect(() => {
    try {
      ...
      if ((s == null ? void 0 : s.unlocked) && (s == null ? void 0 : s.ts) && Date.now() - s.ts < 30 * 24 * 60 * 60 * 1e3) setIsUnlocked(true);
      else if ((s == null ? void 0 : s.unlocked) && (!(s == null ? void 0 : s.ts) || Date.now() - s.ts >= 30 * 24 * 60 * 60 * 1e3)) localStorage.removeItem("keystone_unlock");
    } catch (e) {
    }
  }, []);
  const handleUnlock = async (e) => {
    ...
    try {
      ...
      setUnlockStatus(`error:${(data == null ? void 0 : data.message) || "Invalid passkey."}`);
    } catch (e2) {
  ...
  const handleGeneratePlan = async () => {
    ...
    try {
      ...
      setPlanScore((_a = data.score) != null ? _a : null);
      setFootprintInfo((_b = data.footprintInfo) != null ? _b : null);
  ...
  const handleRefine = async (instruction) => {
    ...
    try {
      ...
      const summary = changes.length > 0 ? changes.map((c) => {
        var _a;
        const room = (_a = planSpec.levels) == null ? void 0 : _a.flatMap((l) => l.rooms || []).find((r) => r.id === c.id);
        const name = (room == null ? void 0 : room.label) || c.id;
  ...
  )), !isUnlocked && /* @__PURE__ */ React.createElement("div", { className: "studio-access-grid mb-8" }, /* @__PURE__ */ React.createElement("div", { className: "dream-panel studio-access-card p-6 md:p-8" }, /* @__PURE__ */ React.createElement("div", { className: "w-11 h-11 bg-white/10 rounded-full flex items-center justify-center mb-5" }, /* @__PURE__ */ React.createElement("svg", { className: "w-5 h-5 text-white", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" }))), /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(244,239,230,0.56)" } }, "Private beta access"), /* @__PURE__ */ React.createElement("h3", { className: "cg text-white mt-4", style: { fontSize: "clamp(1.9rem, 3vw, 2.6rem)", letterSpacing: "-0.05em", textTransform: "uppercase", lineHeight: 0.94 } }, "Unlock the same passkey-based workflow firms share with clients."), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.66)" } }, "Use a passkey if you already have one, or request a guided walkthrough if you want to see how the client link and architect handoff work in practice."), /* @__PURE__ */ React.createElement("form", { onSubmit: handleUnlock, className: "space-y-3 mt-6" }, /* @__PURE__ */ React.createElement("input", { type: "password", placeholder: "Enter access code", className: "text-center tracking-[0.2em]", value: passkeyInput, onChange: (e) => setPasskeyInput(e.target.value), required: true, style: { background: "rgba(255,255,255,0.92)", borderColor: "rgba(255,255,255,0.2)" } }), /* @__PURE__ */ React.createElement("button", { type: "submit", disabled: unlockStatus === "loading", className: "cta-hero cta-glow w-full" }, unlockStatus === "loading" ? "Verifying..." : "Unlock Live Studio")), unlockStatus.startsWith("error:") && /* @__PURE__ */ React.createElement("p", { className: "mt-3 mono text-[9px] uppercase font-bold text-red" }, unlockStatus.replace("error:", "")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3 mt-6" }, /* @__PURE__ */ React.createElement("div", { className: "studio-metric" }, /* @__PURE__ */ React.createElement("strong", null, "3"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] uppercase tracking-[0.18em]", style: { color: "rgba(244,239,230,0.5)" } }, "live outputs")), /* @__PURE__ */ React.createElement("div", { className: "studio-metric" }, /* @__PURE__ */ React.createElement("strong", null, "1"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] uppercase tracking-[0.18em]", style: { color: "rgba(244,239,230,0.5)" } }, "sample brief loaded"))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 pt-5 border-t border-white/10" }, /* @__PURE__ */ React.createElement("p", { className: "text-[11px]", style: { color: "rgba(244,239,230,0.6)" } }, "Need guided access for your firm first?"), /* @__PURE__ */ React.createElement("button", { onClick: onOpenModal, className: "mt-3 cta-hero cta-glow-soft" }, "Request Access"))), /* @__PURE__ */ React.createElement("div", { className: "paper-panel studio-preview-card p-5 md:p-6" }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.44)" } }, "What opens up"), /* @__PURE__ */ React.createElement("h3", { className: "cg mt-4", style: { fontSize: "clamp(1.85rem, 3vw, 2.5rem)", lineHeight: 0.95, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "What the architect gets back is already sitting inside the product."), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, "One client intake becomes a structured brief, a blueprint first, and a Gemini study second. The goal is not spectacle. It is a stronger first discussion for the studio."), /* @__PURE__ */ React.createElement("div", { className: "studio-preview-rail mt-5" }, LIVE_STUDIO_PREVIEW.map((item) => /* @__PURE__ */ React.createElement("article", { key: item.label, className: "studio-preview-browser" }, /* @__PURE__ */ React.createElement("div", { className: "proof-browser-top" }, /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FF5F57" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FFBD2E" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#28C840" } }), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] ml-3", style: { color: "rgba(255,255,255,0.32)", letterSpacing: "0.16em" } }, item.label)), /* @__PURE__ */ React.createElement("div", { className: "studio-preview-screen" }, /* @__PURE__ */ React.createElement(SmartImage, { src: item.image, alt: item.alt, style: { width: "100%", height: "100%", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "studio-preview-copy" }, /* @__PURE__ */ React.createElement("strong", null, item.title), /* @__PURE__ */ React.createElement("p", null, item.body))))), /* @__PURE__ */ React.createElement("div", { className: "unlock-preview-grid mt-5" }, GENERATOR_UNLOCK_PREVIEW.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.label, className: "unlock-preview-card", style: { background: "rgba(255,255,255,0.64)", borderColor: "rgba(10,10,12,0.08)" } }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[8px] uppercase tracking-[0.2em]", style: { color: "rgba(10,10,12,0.42)" } }, item.label), /* @__PURE__ */ React.createElement("p", { style: { color: "rgba(10,10,12,0.66)" } }, item.body)))))), /* @__PURE__ */ React.createElement("div", { className: `grid lg:grid-cols-[300px_minmax(0,1fr)_300px] gap-4 items-start transition-opacity ${!isUnlocked ? "opacity-10 pointer-events-none blur-sm select-none" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "cad-panel-brief" }, /* @__PURE__ */ React.createElement("div", { className: "cad-panel-brief-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mono text-[7px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.36)" } }, "The Brief"), /* @__PURE__ */ React.createElement("div", { className: "cg text-sm font-bold", style: { letterSpacing: "-0.02em", marginTop: 1 } }, "Project Parameters")), isLoading ? /* @__PURE__ */ React.createElement("div", { className: "w-3 h-3 border-[2px] border-blue border-t-transparent rounded-full animate-spin" }) : planSvg ? /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 4, background: "rgba(27,79,130,0.1)", color: "var(--blue)", padding: "3px 8px", borderRadius: 99, fontSize: 8, fontFamily: "IBM Plex Mono,monospace", letterSpacing: "0.14em", textTransform: "uppercase" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 5, height: 5, borderRadius: "50%", background: "var(--blue)", display: "inline-block" } }), "Ready") : null), /* @__PURE__ */ React.createElement("div", { className: "cad-panel-brief-body" }, /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 12px 12px" } }, /* @__PURE__ */ React.createElement(SurveyForm, { formData, setFormData, onSubmit: handleGeneratePlan, isLoading, onReset: resetSampleBrief })))), /* @__PURE__ */ React.createElement("div", { className: "cad-canvas-panel" }, /* @__PURE__ */ React.createElement("div", { className: "cad-canvas-titleblock" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("svg", { width: "12", height: "12", fill: "none", stroke: "rgba(244,239,230,0.4)", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", d: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" })), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 8, color: "rgba(244,239,230,0.38)", letterSpacing: "0.18em", textTransform: "uppercase" } }, planSvg && footprintInfo ? `${footprintInfo.widthFt}' x ${footprintInfo.heightFt}' | ${formData.stories || ""} | ${formData.bedrooms || ""}` : "Blueprint Viewport")), planSvg && planScore != null ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 7, color: "rgba(244,239,230,0.3)", letterSpacing: "0.14em", textTransform: "uppercase" } }, "AI Score"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 9, fontWeight: 700, color: planScore >= 70 ? "#4ade80" : planScore >= 40 ? "#facc15" : "#f87171" } }, planScore, "/100")) : /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 7, color: "rgba(244,239,230,0.2)", letterSpacing: "0.16em", textTransform: "uppercase" } }, "Keystone AI | Blueprint")), /* @__PURE__ */ React.createElement("div", { className: "cad-canvas-body" }, status === "idle" && /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex flex-col items-center justify-center p-12 text-center", style: { color: "rgba(244,239,230,0.42)" }, role: "status", "aria-live": "polite" }, /* @__PURE__ */ React.createElement("svg", { className: "w-16 h-16 mb-4 opacity-50", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1", d: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" })), /* @__PURE__ */ React.createElement("p", { className: "cg text-2xl text-white", style: { letterSpacing: "-0.05em", textTransform: "uppercase" } }, "Awaiting your brief"), /* @__PURE__ */ React.createElement("p", { className: "mono text-[9px] uppercase tracking-widest mt-2" }, "Complete the survey to generate the first plan")), isLoading && /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex flex-col items-center justify-center p-12 text-white", role: "status", "aria-live": "polite" }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 border-[3px] border-blue border-t-transparent rounded-full animate-spin mb-6" }), /* @__PURE__ */ React.createElement("p", { className: "mono text-[10px] uppercase tracking-widest animate-pulse text-blue" }, status === "refining" ? "Applying refinement..." : "Generating floor plan..."), /* @__PURE__ */ React.createElement("p", { className: "text-[9px] mt-2", style: { color: "rgba(244,239,230,0.5)" } }, "Usually under 5 seconds")), (status === "plan-ready" || status === "refining") && planSvg && /* @__PURE__ */ React.createElement(InteractiveCanvas, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" }, dangerouslySetInnerHTML: { __html: planSvg } })))), /* @__PURE__ */ React.createElement("div", { className: "cad-panel-actions" }, (status === "plan-ready" || status === "refining") && planSvg ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "paper-panel p-5" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "badge", style: { background: status === "refining" ? "#fff6ed" : "var(--paper)", borderColor: status === "refining" ? "var(--accent)" : "var(--blue)" } }, status === "refining" ? "Refining..." : "Plan ready"), /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] uppercase tracking-[0.22em] text-mid font-bold" }, refinementsLeft, " updates left")), footprintInfo && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { className: "cad-metric-chip" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Footprint"), /* @__PURE__ */ React.createElement("span", { className: "value" }, footprintInfo.widthFt, "' x ", footprintInfo.heightFt, "'")), planScore != null && /* @__PURE__ */ React.createElement("div", { className: "cad-metric-chip", style: { flexDirection: "column", alignItems: "flex-start", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", width: "100%" } }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "AI Score"), /* @__PURE__ */ React.createElement("span", { className: "value", style: { color: planScore >= 70 ? "#16a34a" : planScore >= 40 ? "#b45309" : "#dc2626" } }, planScore, " / 100")), /* @__PURE__ */ React.createElement("div", { className: "cad-score-bar", style: { width: "100%" } }, /* @__PURE__ */ React.createElement("div", { className: "cad-score-fill", style: { width: `${Math.min(100, planScore)}%` } })))), /* @__PURE__ */ React.createElement("button", { onClick: downloadBlueprint, className: "w-full cta-hero cta-glow py-3 text-[10px] mt-1 shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all" }, "Download High-Res PNG"), /* @__PURE__ */ React.createElement("button", { onClick: downloadDxf, className: "w-full px-4 py-3 border border-black/10 rounded-sm hover:border-blue hover:text-blue text-[10px] font-bold uppercase tracking-widest transition-all bg-white shadow-sm flex items-center justify-center gap-2" }, "Export Vector DXF"), alternatives.length > 0 && /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAlternatives(true), className: "w-full cta-secondary py-3 text-[10px]" }, "View Alternatives (", alternatives.length, ")"))), /* @__PURE__ */ React.createElement("div", { className: "paper-panel" }, /* @__PURE__ */ React.createElement(RefinementPanel, { planSpec, formData, refinementsLeft, refinementHistory, onRefine: handleRefine, isLoading })), /* @__PURE__ */ React.createElement(ElevationsPanel, { elevations: planSpec == null ? void 0 : planSpec.elevations, formData, onOpenPreview: (img) => setZoomImage(img) }), /* @__PURE__ */ React.createElement("div", { className: "paper-panel" }, /* @__PURE__ */ React.createElement(Render3DPanel, { planSpec, formData, planSvg, elevations: planSpec == null ? void 0 : planSpec.elevations, galleryId, onRenderReady: (img) => setZoomImage(img) })), /* @__PURE__ */ React.createElement("div", { className: "paper-panel" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 border-b border-black/5 bg-white/40" }, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "Spec Details")), /* @__PURE__ */ React.createElement(PlanSummaryPanel, { planSpec }))) : /* @__PURE__ */ React.createElement("div", { className: "paper-panel p-6 text-center text-mid flex flex-col items-center justify-center h-full" }, /* @__PURE__ */ React.createElement("svg", { className: "w-8 h-8 mb-3 opacity-20", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1", d: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" })), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] leading-relaxed" }, "Once you generate a plan, export options, AI refinement tools, and structural metrics will appear here.")))), showAlternatives && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[200] flex items-center justify-center p-4", style: { background: "rgba(0,0,0,0.7)" } }, /* @__PURE__ */ React.createElement("div", { className: "bg-paper rounded-lg shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between p-4 border-b border-black/10" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold text-sm" }, "Other Generated Plans"), /* @__PURE__ */ React.createElement("p", { className: "mono text-[8px] text-mid mt-0.5 uppercase tracking-widest" }, alternatives.length, " alternative footprints - click any to use it")), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAlternatives(false), className: "w-8 h-8 flex items-center justify-center rounded hover:bg-black/8 text-mid hover:text-ink transition-colors" }, /* @__PURE__ */ React.createElement("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" })))), /* @__PURE__ */ React.createElement("div", { className: "overflow-y-auto p-4 grid grid-cols-2 md:grid-cols-3 gap-4" }, alternatives.map((alt, i) => {
    var _a;
    return /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-paper/60 border-t border-black/5" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] text-mid" }, alt.footprintInfo ? `${alt.footprintInfo.widthFt} x ${alt.footprintInfo.heightFt} ft` : `Option ${i + 2}`), alt.footprintInfo && /* @__PURE__ */ React.createElement("span", { className: "mono text-[7px] text-mid" }, "ratio ", (_a = alt.footprintInfo.aspectRatio) == null ? void 0 : _a.toFixed(2))), alt.score !== void 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-1 h-1 bg-black/8 rounded-full overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-blue/60 rounded-full transition-all", style: { width: `${Math.min(100, alt.score)}%` } })), /* @__PURE__ */ React.createElement("p", { className: "mono text-[7px] text-blue mt-1 group-hover:text-ink" }, alt.score !== void 0 ? `Score ${alt.score}/100` : "", " - Click to use"))
    );
...
const PageNav = ({ onOpenModal }) => /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement(BrandLockup, { href: "/", compact: true }),
  /* @__PURE__ */ React.createElement("div", { className: "hidden md:flex items-center gap-6 mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(9,9,9,0.54)" } }, PAGE_NAV_LINKS.map(([label, href]) => /* @__PURE__ */ React.createElement("a", { key: href, href, className: "transition-colors hover:text-black" }, label)), /* @__PURE__ */ React.createElement("button", { onClick: onOpenModal, className: "cta-hero cta-glow-soft px-5 py-3 text-[11px]" }, "Request Access")),
...
const DreamApp = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "pb-[60px] md:pb-0" }, /* @__PURE__ */ React.createElement(JoinModal, { isOpen: isModalOpen, onClose: () => setModalOpen(false) }), /* @__PURE__ */ React.createElement(ClickSparkGlobal, null), /* @__PURE__ */ React.createElement(SplashCursor, { SIM_RESOLUTION: 32, DYE_RESOLUTION: 1440, DENSITY_DISSIPATION: 8, VELOCITY_DISSIPATION: 0.6, PRESSURE: 0.1, CURL: 2, SPLAT_RADIUS: 0.12, SPLAT_FORCE: 3e3, COLOR_UPDATE_SPEED: 8, TRANSPARENT: true }), /* @__PURE__ */ React.createElement(MobileNavBar, { onOpenMenu: () => setMenuOpen(true) }), /* @__PURE__ */ React.createElement(MobileMenuOverlay, { isOpen: isMenuOpen, onClose: () => setMenuOpen(false), onJoin: () => setModalOpen(true) }), /* @__PURE__ */ React.createElement(SectionRail, null), /* @__PURE__ */ React.createElement(AnimatePresence, null, !heroVisible && /* @__PURE__ */ React.createElement(
    motion.div,
    {
    ...
    /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator") }, /* @__PURE__ */ React.createElement("span", null, "Open Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Now"))
    ...
    /* @__PURE__ */ React.createElement(BrandLockup, { href: "#hero", compact: true }),
    /* @__PURE__ */ React.createElement("div", { className: "hidden md:flex items-center gap-6 mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(9,9,9,0.52)" } }, HOME_NAV_ITEMS.map((item) => /* @__PURE__ */ React.createElement("a", { key: item.label, href: navHref(item, true), className: "transition-colors hover:text-black" }, item.label)), /* @__PURE__ */ React.createElement("button", { onClick: () => setModalOpen(true), className: "cta-hero cta-glow px-5 py-3 text-[11px]" }, "Request Access"))
  ), /* @__PURE__ */ React.createElement(
    "section",
    {
      id: "hero",
    ...
    /* @__PURE__ */ React.createElement(OrbBackground, null),
    /* @__PURE__ */ React.createElement(Waves, { lineColor: "rgba(255,106,55,0.18)", waveSpeedX: 0.012, waveSpeedY: 0.012, waveAmpX: 40, waveAmpY: 10, friction: 0.62, tension: 0.022, maxCursorMove: 90, xGap: 12, yGap: 36 }),
    /* @__PURE__ */ React.createElement(FloatingParticles, { count: 55, color: "255,106,55", className: "opacity-50" }),
    /* @__PURE__ */ React.createElement(DotGridHero, null),
    /* @__PURE__ */ React.createElement(GradualBlur, { target: "parent", position: "bottom", height: "7rem", strength: 2.2, divCount: 6, curve: "bezier", exponential: true, opacity: 1 }),
    /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.12 }, className: "mb-6" }, /* @__PURE__ */ React.createElement("span", { className: "hero-badge" }, /* @__PURE__ */ React.createElement("span", { className: "hero-badge-dot" }), "Architect-first discovery")), /* @__PURE__ */ React.createElement(
        motion.h1,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
        ...
        /* @__PURE__ */ React.createElement("span", { className: "block" }, /* @__PURE__ */ React.createElement(
          BlurText,
          {
        ...
        /* @__PURE__ */ React.createElement("span", { className: "block", style: { color: "rgba(78,69,61,0.78)" } }, "before the meeting.")
      ), /* @__PURE__ */ React.createElement(
        motion.p,
        {
        ...
        /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator"), "data-cursor-text": "Open studio" }, /* @__PURE__ */ React.createElement("span", null, "Open Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Try it now")),
        ...
        LIVE_NOW_FEATURES.map((item) => /* @__PURE__ */ React.createElement("span", { key: item, className: "marquee-pill marquee-pill-orange", style: { animation: "none" } }, item))
      ), /* @__PURE__ */ React.createElement(
        motion.div,
        {
          initial: { opacity: 0, y: 14 },
        ...
        HERO_SIGNAL_CARDS.map((item) => /* @__PURE__ */ React.createElement(TiltCard, { key: item.label, maxTilt: 5 }, /* @__PURE__ */ React.createElement(
          SpotlightCard,
          {
          ...
          /* @__PURE__ */ React.createElement("div", { className: "mono text-[9px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.7 } }, item.label),
          /* @__PURE__ */ React.createElement("h3", { className: "hero-proof-value" }, item.value),
          /* @__PURE__ */ React.createElement("p", { className: "hero-proof-note" }, item.note)
        )))
      )),
      /* @__PURE__ */ React.createElement(
        motion.aside,
        ...
        /* @__PURE__ */ React.createElement("div", { className: "absolute right-0 bottom-0 w-64 h-64 pointer-events-none", style: {
          background: "radial-gradient(circle at 80% 80%, rgba(255,106,55,0.12), transparent 60%)"
        } }),
        /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(245,240,233,0.55)" } }, "Inside the room"),
        /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-4", style: { fontSize: "clamp(1.7rem,3.1vw,2.6rem)", lineHeight: 0.92, textTransform: "uppercase", letterSpacing: "-0.055em" } }, "A first pass that already feels worth discussing."),
        /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.6)" } }, "Clients arrive with something they can point to. Your team arrives with something they can shape."),
        /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3 mt-6" }, studioMetrics.map((metric) => /* @__PURE__ */ React.createElement("div", { key: metric.label, className: "studio-metric" }, /* @__PURE__ */ React.createElement("strong", null, metric.value), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] uppercase tracking-[0.18em]", style: { color: "rgba(244,239,230,0.46)" } }, metric.label)))),
        /* @__PURE__ */ React.createElement("div", { className: "mt-5 pt-4 border-t border-white/10" }, /* @__PURE__ */ React.createElement("p", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(244,239,230,0.46)" } }, "Method before meeting"), /* @__PURE__ */ React.createElement("a", { href: "/how-floor-plans-work", "data-cursor-text": "Open methodology page", className: "inline-block mt-3 text-sm transition-colors hover:text-orange-300", style: { color: "rgba(255,255,255,0.88)" } }, "See how Keystone makes floor plans \xE2\u2020\u2019"))
      )
    ))
  ), /* @__PURE__ */ React.createElement("section", { id: "proof", className: "proof-shelf relative overflow-hidden" }, /* @__PURE__ */ React.createElement(OrbBackground, null), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "proof-frame p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "proof-top-grid" }, /* @__PURE__ */ React.createElement("div", { className: "p-2 md:p-4" }, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.44)" } }, "Sample session"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" })), /* @__PURE__ */ React.createElement(Reveal, { y: 28, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-5", style: { fontSize: "clamp(2.1rem, 4.6vw, 3.8rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "Real output. ", /* @__PURE__ */ React.createElement(GradientText, { className: "serif" }, "No imagination tax."))), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.16 }, /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm md:text-base leading-relaxed", style: { color: "rgba(10,10,12,0.62)" } }, "The fastest way to trust Keystone is to watch the whole firm workflow happen in sequence: client brief, generated plan, export-ready blueprint, and optional Gemini study before the first architect meeting."), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-wrap gap-3" }, /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator") }, /* @__PURE__ */ React.createElement("span", null, "Open Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Now")), /* @__PURE__ */ React.createElement("a", { href: "/how-floor-plans-work", "data-cursor-text": "Open methodology page", className: "cta-secondary" }, "How Floor Plans Work")))), /* @__PURE__ */ React.createElement("div", { className: "proof-journey-rail mt-2 md:mt-0" }, SAMPLE_SESSION_STEPS.map((item, index) => /* @__PURE__ */ React.createElement(
    motion.article,
    {
      key: item.number,
      initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4 }, /* @__PURE__ */ React.createElement(
      SpotlightCard,
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "proof-journey-step", style: { background: "var(--accent)", color: "white" } }, item.number),
      /* @__PURE__ */ React.createElement("h3", null, item.title),
      /* @__PURE__ */ React.createElement("p", null, item.body)
    ))
  )))), /* @__PURE__ */ React.createElement("div", { className: "proof-browsers-grid mt-5" }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 3 }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
    ...
    /* @__PURE__ */ React.createElement("div", { className: "proof-caption" }, /* @__PURE__ */ React.createElement("span", { className: "proof-dot", style: { background: "var(--accent)" } }), "Client footprint translated into a working blueprint")
  )), /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 3 }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
      initial: { opacity: 0, y: 20 },
      whileInView: { opacity: 1, y: 0 },
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.8 } }, item.eyebrow),
    ...
    /* @__PURE__ */ React.createElement("div", { className: "proof-feature-copy" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.8 } }, item.eyebrow), /* @__PURE__ */ React.createElement("h3", { className: "cg mt-3 text-[1.3rem] leading-[0.98]", style: { color: "var(--ink)" } }, item.title), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.62)" } }, item.body))
  )))))), /* @__PURE__ */ React.createElement("section", { className: "defer-section py-12 md:py-14 relative overflow-hidden", style: { background: "var(--paper)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 30, color: "255,106,55", className: "opacity-30" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement(Reveal, { y: 24 }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 2 }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.12)", className: "paper-panel p-7 md:p-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_260px] gap-8 items-end" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(9,9,9,0.42)" } }, "Live studio"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3 mb-5" }), /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.6rem, 6vw, 4.8rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase", color: "var(--ink)" } }, "Try the real workflow, not a teaser."), /* @__PURE__ */ React.createElement("p", { className: "mt-5 max-w-2xl text-base leading-relaxed", style: { color: "rgba(9,9,9,0.62)" } }, "The same client-to-studio logic behind the hero is right below. Open the live studio, walk through the guided intake, shape a plan, and see what the architect gets back before kickoff.")), /* @__PURE__ */ React.createElement("div", { className: "flex justify-start lg:justify-end" }, /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator") }, /* @__PURE__ */ React.createElement("span", null, "Open Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Try it now"))))))))), /* @__PURE__ */ React.createElement(AnimatePresence, null, isStudioOpen && /* @__PURE__ */ React.createElement(
    motion.div,
    {
      key: "studio-modal",
      initial: { opacity: 0 },
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "studio-modal-topbar" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("img", { src: ASSETS.icon, alt: "Keystone", style: { width: 22, height: 22, opacity: 0.85 } }), /* @__PURE__ */ React.createElement("span", { className: "cg", style: { fontSize: "1rem", fontWeight: 700, letterSpacing: "-0.03em" } }, "Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 8, color: "rgba(10,10,12,0.36)", letterSpacing: "0.18em", textTransform: "uppercase", marginLeft: 4 } }, "Keystone AI")), /* @__PURE__ */ React.createElement("button", { className: "studio-modal-close", onClick: () => setStudioOpen(false), "aria-label": "Close Live Studio" }, /* @__PURE__ */ React.createElement("svg", { width: "14", height: "14", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" })))),
      /* @__PURE__ */ React.createElement("div", { className: "studio-modal-body" }, /* @__PURE__ */ React.createElement(DesignGenerator, { onOpenModal: () => setModalOpen(true) }))
    )
  )), /* @__PURE__ */ React.createElement(Gallery, { onOpenModal: () => setModalOpen(true) }), /* @__PURE__ */ React.createElement("section", { className: "relative py-5 border-y overflow-hidden", style: { background: "linear-gradient(90deg,#FFF8F5,#FFF3ED,#FFF8F5)", borderColor: "rgba(255,106,55,0.15)" } }, /* @__PURE__ */ React.createElement("div", { className: "marquee-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "marquee-track px-5 md:px-10" }, [...marqueeItems, ...marqueeItems].map((item, index) => /* @__PURE__ */ React.createElement("span", { key: `${item}-${index}`, className: "marquee-pill marquee-pill-orange" }, item))))), /* @__PURE__ */ React.createElement("section", { className: "defer-section py-12 md:py-16 relative overflow-hidden", style: { background: "linear-gradient(180deg,#0A0806 0%,#130B05 100%)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 30, color: "255,106,55", className: "opacity-20" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement(Reveal, { y: 16 }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(255,106,55,0.7)" } }, "What's inside"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3 mb-2" }), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-5", style: { fontSize: "clamp(2rem,4.5vw,3.6rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase", maxWidth: "32rem" } }, "Every session. ", /* @__PURE__ */ React.createElement(GradientText, null, "Six capabilities."))), /* @__PURE__ */ React.createElement("div", { className: "mt-8" }, /* @__PURE__ */ React.createElement(MagicBento, { glowColor: "255,106,55", spotlightRadius: 420, particleCount: 10, clickEffect: true })))), /* @__PURE__ */ React.createElement("section", { id: "work", className: "defer-section py-14 md:py-[4.75rem]", style: { background: "var(--paper)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_320px] gap-10 items-end mb-10 md:mb-12" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "What changes"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" })), /* @__PURE__ */ React.createElement(Reveal, { y: 32, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.8rem, 7vw, 5.8rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase", color: "var(--ink)" } }, "The point is not more content. ", /* @__PURE__ */ React.createElement(GradientText, null, "Better-prepared"), " first meetings."))), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.18 }, /* @__PURE__ */ React.createElement("p", { className: "text-sm md:text-base leading-relaxed", style: { color: "rgba(9,9,9,0.58)" } }, "Keystone works when the client, the architect, and the next decision all feel less vague. These are the business-level shifts the workflow is built to create for firms."))), /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-3 gap-4" }, outcomeCards.map((item, index) => /* @__PURE__ */ React.createElement(motion.article, { key: item.eyebrow, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 5, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(
    SpotlightCard,
    {
      spotlightColor: "rgba(255,106,55,0.12)",
      className: "outcome-card p-6 md:p-7 flex flex-col justify-between min-h-[300px] h-full"
    },
    /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.8 } }, item.eyebrow), /* @__PURE__ */ React.createElement("h3", { className: "cg mt-5 text-[2rem] leading-[0.94]", style: { color: "var(--ink)" } }, item.title), /* @__PURE__ */ React.createElement("p", { className: "mt-5 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.66)" } }, item.body)),
    /* @__PURE__ */ React.createElement("div", { className: "mt-10 pt-5", style: { borderTop: "1px solid rgba(255,106,55,0.15)" } }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.7 } }, "Keystone signal"), /* @__PURE__ */ React.createElement("div", { className: "cg mt-3 text-[2.4rem] leading-none gradient-text-anim", style: { letterSpacing: "-0.06em" } }, item.stat))
  ))))))), /* @__PURE__ */ React.createElement("section", { className: "defer-section py-14 md:py-[4.75rem] relative overflow-hidden", style: { background: "linear-gradient(180deg, #FFFDFC 0%, #F7F1E8 100%)" } }, /* @__PURE__ */ React.createElement(OrbBackground, null), /* @__PURE__ */ React.createElement(FloatingParticles, { count: 28, color: "255,106,55", className: "opacity-24" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[280px_minmax(0,1fr)] gap-8 items-end" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(9,9,9,0.42)" } }, "Platform pages"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" })), /* @__PURE__ */ React.createElement(Reveal, { y: 26, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.4rem, 5vw, 4.6rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "Three clearer ways to understand Keystone."))), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.16 }, /* @__PURE__ */ React.createElement("p", { className: "text-sm md:text-base leading-relaxed", style: { color: "rgba(9,9,9,0.6)" } }, "The homepage keeps the live product story. These pages go deeper into the floor-plan method, the firm workflow, and the roadmap without flattening everything into one long scroll."))), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-3 gap-4 mt-10" }, PLATFORM_PAGE_CARDS.map((card, index) => /* @__PURE__ */ React.createElement(motion.article, { key: card.href, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.12)", className: "h-full", style: { background: "rgba(255,255,255,0.78)", border: "1px solid rgba(255,106,55,0.1)", borderRadius: "22px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { aspectRatio: "1 / 0.78", overflow: "hidden", position: "relative" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: card.image, alt: card.alt, style: { width: "100%", height: "100%", objectFit: "cover", display: "block" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(9,9,9,0.02) 0%, rgba(9,9,9,0.42) 100%)" } }), /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { position: "absolute", left: "1rem", right: "1rem", top: "1rem", color: "rgba(255,255,255,0.78)" } }, card.eyebrow), /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { position: "absolute", left: "1rem", bottom: "1rem", color: "white" } }, card.stat)), /* @__PURE__ */ React.createElement("div", { className: "p-5 md:p-6" }, /* @__PURE__ */ React.createElement("h3", { className: "cg text-[1.8rem] leading-[0.94]", style: { color: "var(--ink)" } }, card.title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.62)" } }, card.body), /* @__PURE__ */ React.createElement("a", { href: card.href, className: "cta-secondary mt-6 inline-flex" }, card.cta))))))))), /* @__PURE__ */ React.createElement("section", { id: "services", className: "defer-section py-14 md:py-[4.75rem] relative overflow-hidden", style: { background: "linear-gradient(180deg, #ECE3D3 0%, #F7F2E9 60%, #F0EBE1 100%)", color: "var(--ink)" } }, /* @__PURE__ */ React.createElement(OrbBackground, null), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_320px] gap-12 items-end" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.45)" } }, "Firm workflow"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" })), /* @__PURE__ */ React.createElement(Reveal, { y: 32, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.8rem, 7vw, 5.4rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "A ", /* @__PURE__ */ React.createElement(GradientText, null, "calmer way"), " to move from first inquiry to architect-ready intent."))), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.18 }, /* @__PURE__ */ React.createElement("p", { className: "text-sm md:text-base leading-relaxed text-mid" }, "Keystone is not trying to replace architectural judgment. It gives firms a better handoff from client curiosity to the first serious design conversation."))), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_340px] gap-6 mt-10 items-start" }, /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-3 gap-5 self-start" }, serviceCards.map((card, index) => /* @__PURE__ */ React.createElement(motion.div, { key: card.number, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 6, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(
    SpotlightCard,
    {
      spotlightColor: "rgba(255,106,55,0.14)",
      className: "service-card-v2 p-6 md:p-7 self-start h-full"
    },
    /* @__PURE__ */ React.createElement("div", { className: "service-number" }, card.number),
  ...
  ))))), /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.1)", className: "paper-panel p-6 md:p-7 self-start" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "var(--accent)", opacity: 0.8 } }, "Inside every session"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3 mb-4" }), /* @__PURE__ */ React.createElement("h3", { className: "cg mt-5 text-[2.1rem] leading-[0.95]" }, "The studio stack clients never see, but your team will feel."), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-6" }, sessionStack.map((item) => /* @__PURE__ */ React.createElement("span", { key: item, className: "session-stack-pill" }, item))), /* @__PURE__ */ React.createElement("div", { className: "mt-8 pt-6", style: { borderTop: "1px solid rgba(255,106,55,0.12)" } }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "var(--accent)", opacity: 0.6 } }, "Coming next"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 mt-4" }, roadmapCards.map((item) => /* @__PURE__ */ React.createElement("div", { key: item, className: "flex items-center gap-3 text-sm", style: { color: "var(--mid)" } }, /* @__PURE__ */ React.createElement("span", { className: "w-2 h-2 rounded-full flex-shrink-0", style: { background: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, item))))))), /* @__PURE__ */ React.createElement("div", { className: "service-summary-grid mt-8" }, SERVICE_BENEFITS.map((item, index) => /* @__PURE__ */ React.createElement(
    motion.article,
    {
      key: item.eyebrow,
      initial: { opacity: 0, y: 18 },
    ...
    /* @__PURE__ */ React.createElement("h3", null, item.title),
    /* @__PURE__ */ React.createElement("p", null, item.body)
  ))))), /* @__PURE__ */ React.createElement("section", { id: "pricing", className: "defer-section py-14 md:py-[4.75rem] relative overflow-hidden", style: { background: "var(--paper)", color: "var(--ink)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 25, color: "255,106,55", className: "opacity-20" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-3xl" }, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.45)" } }, "Pricing"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" })), /* @__PURE__ */ React.createElement(Reveal, { y: 32, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.4rem, 5.6vw, 4.5rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase" } }, /* @__PURE__ */ React.createElement(GradientText, null, "Clear pricing"), " before your team commits the hours.")), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.18 }, /* @__PURE__ */ React.createElement("p", { className: "mt-5 text-base leading-relaxed", style: { color: "var(--mid)" } }, "Start with a guided demo, try one live client session, or turn Keystone into a repeatable pre-meeting rhythm without a dead-month subscription."))), /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[minmax(0,1fr)_300px] gap-6 mt-10 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-3 gap-4" }, pricingTiers.map((tier, index) => /* @__PURE__ */ React.createElement(motion.div, { key: tier.tag, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, tier.featured ? /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 5, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(
    SpotlightCard,
    {
      spotlightColor: "rgba(255,106,55,0.2)",
      className: "pricing-featured p-6 md:p-7 flex flex-col min-h-[360px] h-full"
    },
    /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(255,255,255,0.6)" } }, tier.tag),
    /* @__PURE__ */ React.createElement("div", { className: "cg mt-5 text-white", style: { fontSize: "3rem", lineHeight: 0.88, letterSpacing: "-0.06em" } }, tier.price),
    /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em] mt-2", style: { color: "rgba(255,255,255,0.46)" } }, tier.unit),
    /* @__PURE__ */ React.createElement("p", { className: "mt-5 text-sm leading-relaxed flex-1", style: { color: "rgba(255,255,255,0.72)" } }, tier.desc),
    /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator"), className: "w-full mt-6" }, /* @__PURE__ */ React.createElement("span", null, tier.cta), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Now"))
  )) : /* @__PURE__ */ React.createElement(
    SpotlightCard,
    {
      spotlightColor: "rgba(255,106,55,0.1)",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.4)" } }, tier.tag),
    /* @__PURE__ */ React.createElement("div", { className: "cg mt-5", style: { fontSize: "3rem", lineHeight: 0.88, letterSpacing: "-0.06em" } }, tier.price),
    /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em] mt-2", style: { color: "rgba(10,10,12,0.42)" } }, tier.unit),
    /* @__PURE__ */ React.createElement("p", { className: "mt-5 text-sm leading-relaxed flex-1", style: { color: "var(--mid)" } }, tier.desc),
    /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  ))))), /* @__PURE__ */ React.createElement("div", { className: "grid gap-4" }, quoteCards.map((quote, index) => /* @__PURE__ */ React.createElement(motion.div, { key: quote.name, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.08)", className: "quote-card p-5 h-full" }, /* @__PURE__ */ React.createElement("p", { className: "cg text-[1.2rem] leading-[1.1]", style: { color: "var(--ink)" } }, quote.quote), /* @__PURE__ */ React.createElement("div", { className: "mt-4 pt-4", style: { borderTop: "1px solid rgba(255,106,55,0.12)" } }, /* @__PURE__ */ React.createElement("p", { className: "font-semibold text-sm" }, quote.name), /* @__PURE__ */ React.createElement("p", { className: "mono text-[10px] uppercase tracking-[0.2em] mt-2", style: { color: "var(--mid)" } }, quote.firm))))))))), /* @__PURE__ */ React.createElement("section", { id: "studio", className: "defer-section py-16 md:py-20 relative overflow-hidden", style: { background: "linear-gradient(180deg, rgba(10,10,10,1) 0%, rgba(23,23,23,1) 100%)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 40, color: "255,106,55", className: "opacity-25" }), /* @__PURE__ */ React.createElement("div", { className: "hero-glow", style: { top: "12%", left: "18%", width: "540px", height: "540px", background: "radial-gradient(circle, rgba(255,106,55,0.12), transparent 70%)" } }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_360px] gap-10 items-start" }, /* @__PURE__ */ React.createElement(Reveal, { y: 28 }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.1)", className: "dream-panel p-7 md:p-10 animated-border" }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(232,238,244,0.65)" } }, "Studio"), /* @__PURE__ */ React.createElement("div", { className: "orange-line mt-3" }), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-6", style: { fontSize: "clamp(2.8rem, 7vw, 5.2rem)", lineHeight: 0.9, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "Built by people who have felt the discovery gap up close."), /* @__PURE__ */ React.createElement("p", { className: "mt-6 max-w-2xl text-base leading-relaxed", style: { color: "rgba(244,239,230,0.72)" } }, "Keystone began from a simple frustration: talented architects were burning unpaid hours trying to pull clarity out of clients who had not yet learned how to describe what they wanted."), /* @__PURE__ */ React.createElement("p", { className: "mt-4 max-w-2xl text-base leading-relaxed", style: { color: "rgba(244,239,230,0.72)" } }, "The product is designed to let the client do some of that thinking before the meeting so the architect can spend the kickoff shaping ideas instead of extracting basics."), /* @__PURE__ */ React.createElement("div", { className: "mt-8 pt-6 border-t border-white/10" }, /* @__PURE__ */ React.createElement("p", { className: "cg text-white", style: { fontSize: "clamp(1.6rem, 3vw, 2.6rem)", lineHeight: 1.08 } }, '"Architects should spend their energy shaping ideas, not extracting them one exhausted question at a time."'), /* @__PURE__ */ React.createElement("p", { className: "mono mt-4 text-[10px] uppercase tracking-[0.24em]", style: { color: "rgba(244,239,230,0.5)" } }, "Founder note / Keystone AI")))), /* @__PURE__ */ React.createElement("div", { className: "grid gap-4" }, studioMetrics.map((metric, index) => /* @__PURE__ */ React.createElement(motion.div, { key: metric.label, initial: { opacity: 0, x: 20 }, whileInView: { opacity: 1, x: 0 }, viewport: { once: true, margin: "-48px" }, transition: { duration: 0.5, delay: index * 0.07, ease: [0.22, 1, 0.36, 1] } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4 }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.15)", className: "studio-metric h-full" }, /* @__PURE__ */ React.createElement("strong", { className: "gradient-text-anim" }, metric.value), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] uppercase tracking-[0.18em]", style: { color: "rgba(244,239,230,0.5)" } }, metric.label))))))), /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-3 gap-4 mt-8" }, studioTeam.map((member, index) => /* @__PURE__ */ React.createElement(motion.article, { key: member.name, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.25 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(
    SpotlightCard,
    {
      spotlightColor: "rgba(255,106,55,0.12)",
      className: "dream-panel p-4 md:p-5 flex items-start gap-4 h-full"
    },
    /* @__PURE__ */ React.createElement("div", { className: "rounded-[20px] overflow-hidden flex-shrink-0", style: { width: "88px", height: "104px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,106,55,0.15)" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: member.image, alt: member.name, style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top" } })),
    /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "var(--accent)", opacity: 0.7 } }, member.role), /* @__PURE__ */ React.createElement("h3", { className: "cg text-white text-[1.6rem] mt-2 leading-[0.96]" }, member.name), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-[13px] leading-relaxed", style: { color: "rgba(244,239,230,0.68)" } }, member.bio))
  ))))))), /* @__PURE__ */ React.createElement(SurveySection, { onJoin: () => setModalOpen(true) }), /* @__PURE__ */ React.createElement("section", { className: "defer-section py-20 md:py-28 relative overflow-hidden", style: { background: "linear-gradient(180deg, #FFFDFC 0%, #FFF4EE 60%, #F5F0E9 100%)" } }, /* @__PURE__ */ React.createElement(Waves, { lineColor: "rgba(255,106,55,0.22)", waveSpeedX: 0.01, waveSpeedY: 8e-3, waveAmpX: 30, waveAmpY: 6, friction: 0.7, tension: 0.018, xGap: 14, yGap: 40 }), /* @__PURE__ */ React.createElement(OrbBackground, null), /* @__PURE__ */ React.createElement(FloatingParticles, { count: 45, color: "255,106,55", className: "opacity-35" }), /* @__PURE__ */ React.createElement("div", { className: "container mx-auto max-w-5xl px-5 md:px-10 text-center relative z-10" }, /* @__PURE__ */ React.createElement(Reveal, { y: 12 }, /* @__PURE__ */ React.createElement("span", { className: "section-label justify-center", style: { color: "rgba(9,9,9,0.42)" } }, "Final invitation"), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center mt-3" }, /* @__PURE__ */ React.createElement("div", { className: "orange-line" }))), /* @__PURE__ */ React.createElement(Reveal, { y: 28, delay: 0.08 }, /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(3rem, 7vw, 5.8rem)", lineHeight: 0.88, letterSpacing: "-0.06em", textTransform: "uppercase", color: "var(--ink)" } }, /* @__PURE__ */ React.createElement(BlurText, { text: "Give the first meeting", delay: 50, direction: "bottom", tag: "span", className: "block" }), /* @__PURE__ */ React.createElement("span", { className: "block", style: { color: "var(--accent)" } }, /* @__PURE__ */ React.createElement(BlurText, { text: "a stronger starting point.", delay: 50, direction: "bottom", tag: "span" })))), /* @__PURE__ */ React.createElement(Reveal, { y: 16, delay: 0.22 }, /* @__PURE__ */ React.createElement("p", { className: "mt-5 max-w-2xl mx-auto text-base md:text-lg leading-relaxed", style: { color: "rgba(9,9,9,0.62)" } }, "If the goal is to help residential clients arrive better prepared while protecting your studio's time, Keystone is ready for a real conversation.")), /* @__PURE__ */ React.createElement(Reveal, { y: 20, delay: 0.34 }, /* @__PURE__ */ React.createElement("div", { className: "mt-10 flex flex-col sm:flex-row gap-3 justify-center" }, /* @__PURE__ */ React.createElement(StarBorderBtn, { onClick: () => scrollTo("generator") }, /* @__PURE__ */ React.createElement("span", null, "Open Live Studio"), /* @__PURE__ */ React.createElement("span", { className: "cta-live-mark" }, /* @__PURE__ */ React.createElement("span", { className: "cta-live-dot" }), "Try it now")), /* @__PURE__ */ React.createElement("button", { onClick: () => setModalOpen(true), className: "cta-hero cta-glow-soft" }, "Request Access"))))), /* @__PURE__ */ React.createElement(SiteFooter, { home: true })));
};
const HowFloorPlansWorkPage = () => {
  ...
  return /* @__PURE__ */ React.createElement(SubpageChrome, null, ({ openModal }) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "relative overflow-hidden", style: { background: "linear-gradient(180deg, #FFFDF9 0%, #F2E9DE 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "hero-video-shell" }, /* @__PURE__ */ React.createElement("div", { className: "hero-video-base" }), /* @__PURE__ */ React.createElement("div", { className: "hero-video-wave orange" }), /* @__PURE__ */ React.createElement("div", { className: "hero-video-wave soft" }), /* @__PURE__ */ React.createElement("div", { className: "hero-video-wave sand" })), /* @__PURE__ */ React.createElement("div", { className: "dream-grid absolute inset-0 opacity-70" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell py-16 md:py-24 relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[minmax(0,1.05fr)_360px] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "How floor plans are made"), /* @__PURE__ */ React.createElement("h1", { className: "cg mt-6", style: { fontSize: "clamp(3rem, 7vw, 6rem)", lineHeight: 0.9, letterSpacing: "-0.06em", textTransform: "uppercase", color: "var(--ink)" } }, "How Keystone turns client intent into a first working floor plan."), /* @__PURE__ */ React.createElement("p", { className: "mt-6 max-w-3xl text-base md:text-lg leading-relaxed", style: { color: "rgba(32,26,21,0.72)" } }, "This page explains the actual floor-plan workflow behind Keystone. A firm sends the client a guided brief, Keystone normalizes that information into plan constraints, explores footprint options, builds a room program, lays out the plan, validates circulation, and only then prepares the export and optional Gemini exterior study."), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-2 gap-3 mt-8 max-w-3xl" }, caseFacts.map(([label, value]) => /* @__PURE__ */ React.createElement("div", { key: label, className: "paper-panel p-4 md:p-5" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[9px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.42)" } }, label), /* @__PURE__ */ React.createElement("div", { className: "cg text-[1.4rem] mt-3 leading-[0.95]", style: { color: "var(--ink)" } }, value)))), /* @__PURE__ */ React.createElement("div", { className: "mt-8 flex flex-wrap gap-3" }, /* @__PURE__ */ React.createElement("a", { href: "/#generator", className: "cta-hero cta-glow" }, "Open Live Studio"), /* @__PURE__ */ React.createElement("button", { onClick: openModal, className: "cta-hero cta-glow-soft" }, "Request Access"))), /* @__PURE__ */ React.createElement("aside", { className: "dream-panel p-6 md:p-7 overflow-hidden relative" }, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(245,240,233,0.58)" } }, "What goes in"), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-5", style: { fontSize: "clamp(1.8rem,3vw,2.6rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "Enough specificity to help the architect before the meeting, not just during it."), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 mt-6" }, intakeSignals.map((item) => /* @__PURE__ */ React.createElement("div", { key: item, className: "flex items-start gap-3 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.66)" } }, /* @__PURE__ */ React.createElement("span", { className: "w-2 h-2 rounded-full mt-1.5 flex-shrink-0", style: { background: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, item)))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 rounded-[18px] overflow-hidden", style: { border: "1px solid rgba(255,255,255,0.12)" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: ASSETS.phase3[4], alt: "Keystone guided intake shown on mobile", style: { width: "100%", height: "220px", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "mt-8 pt-5 border-t border-white/10" }, /* @__PURE__ */ React.createElement("p", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(244,239,230,0.46)" } }, "Outcome"), /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed mt-3", style: { color: "rgba(244,239,230,0.7)" } }, "The architect starts with a plan that has already been structured, zoned, and checked for basic circulation. If the team wants an image, Gemini comes after that as an optional exterior study rather than the core planning method.")))))), /* @__PURE__ */ React.createElement("section", { className: "py-10 md:py-14", style: { background: "linear-gradient(180deg, #FFFDFC 0%, #F5F0E9 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "proof-frame p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[1fr_1fr] gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "proof-browser" }, /* @__PURE__ */ React.createElement("div", { className: "proof-browser-top" }, /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FF5F57" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FFBD2E" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#28C840" } }), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] ml-3", style: { color: "rgba(255,255,255,0.32)", letterSpacing: "0.16em" } }, "SAMPLE SESSION / GENERATED PLAN")), /* @__PURE__ */ React.createElement("div", { className: "proof-browser-screen plan" }, /* @__PURE__ */ React.createElement("div", { className: "diagonal-accent" }), /* @__PURE__ */ React.createElement(SmartImage, { src: ASSETS.exampleBlueprint, alt: "Sample generated floor plan", style: { width: "100%", display: "block", objectFit: "contain" } })), /* @__PURE__ */ React.createElement("div", { className: "proof-caption" }, /* @__PURE__ */ React.createElement("span", { className: "proof-dot", style: { background: "var(--blue)" } }), "Keystone turns the brief into a working plan artifact the firm can review, critique, and annotate before kickoff.")), /* @__PURE__ */ React.createElement("div", { className: "proof-browser" }, /* @__PURE__ */ React.createElement("div", { className: "proof-browser-top" }, /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FF5F57" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#FFBD2E" } }), /* @__PURE__ */ React.createElement("div", { className: "bc-dot", style: { background: "#28C840" } }), /* @__PURE__ */ React.createElement("span", { className: "mono text-[8px] ml-3", style: { color: "rgba(255,255,255,0.32)", letterSpacing: "0.16em" } }, "SAMPLE SESSION / GEMINI EXTERIOR STUDY")), /* @__PURE__ */ React.createElement("div", { className: "proof-browser-screen render" }, /* @__PURE__ */ React.createElement(SmartImage, { src: ASSETS.exampleRender, alt: "Sample Gemini exterior study", style: { width: "100%", height: "100%", objectFit: "cover" } })), /* @__PURE__ */ React.createElement("div", { className: "proof-caption" }, /* @__PURE__ */ React.createElement("span", { className: "proof-dot", style: { background: "var(--accent)" } }), "Gemini is optional and comes after the plan, giving the client an exterior mood to react to without replacing the floor-plan logic.")))))), /* @__PURE__ */ React.createElement("section", { className: "py-16 md:py-20", style: { background: "var(--paper)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[320px_minmax(0,1fr)] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.42)" } }, "Method"), /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.4rem, 5vw, 4.3rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "The value is not mystery. It is a tighter planning sequence before the architect enters the room.")), /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 gap-4" }, processSteps.map((item) => /* @__PURE__ */ React.createElement("article", { key: item.step, className: "paper-panel p-5 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(27,79,130,0.72)" } }, item.step), /* @__PURE__ */ React.createElement("h3", { className: "cg text-[1.7rem] mt-5 leading-[0.95]", style: { color: "var(--ink)" } }, item.title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, item.body))))))), /* @__PURE__ */ React.createElement("section", { className: "py-10 md:py-14", style: { background: "linear-gradient(180deg, #FFFDF9 0%, #F0E8DD 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[280px_minmax(0,1fr)] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(10,10,12,0.42)" } }, "What shapes the plan"), /* @__PURE__ */ React.createElement("h2", { className: "cg mt-6", style: { fontSize: "clamp(2.2rem, 4.5vw, 4rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "The floor plan is built from program, zoning, and review logic before mood comes into the picture.")), /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-3 gap-4" }, planInputs.map((item, index) => /* @__PURE__ */ React.createElement(motion.article, { key: item.title, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.12)", className: "h-full", style: { background: "rgba(255,255,255,0.7)", border: "1px solid rgba(255,106,55,0.1)", borderRadius: "22px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { aspectRatio: "1 / 0.78", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: item.image, alt: item.alt, style: { width: "100%", height: "100%", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "p-5 md:p-6" }, /* @__PURE__ */ React.createElement("h3", { className: "cg text-[1.6rem] leading-[0.95]", style: { color: "var(--ink)" } }, item.title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, item.body)))))))))), /* @__PURE__ */ React.createElement("section", { className: "py-12 md:py-16 relative overflow-hidden", style: { background: "linear-gradient(180deg,#0A0806 0%,#130B05 100%)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 28, color: "255,106,55", className: "opacity-18" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_320px] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(255,106,55,0.7)" } }, "Support material"), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-6", style: { fontSize: "clamp(2.3rem, 4.8vw, 4rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "More visual proof, while staying honest about what the system is and is not."), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-8" }, supportingGallery.map((image, index) => /* @__PURE__ */ React.createElement("div", { key: image, className: "rounded-[18px] overflow-hidden", style: { border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: image, alt: `Keystone floor plan support visual ${index + 1}`, style: { width: "100%", height: "210px", objectFit: "cover", display: "block" } }))))), /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.14)", className: "dream-panel p-6 md:p-7 self-start" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "rgba(255,106,55,0.8)" } }, "Important boundary"), /* @__PURE__ */ React.createElement("h3", { className: "cg text-white mt-5 text-[2rem] leading-[0.95]" }, "Keystone helps start the design discussion. It does not replace architectural responsibility."), /* @__PURE__ */ React.createElement("p", { className: "mt-5 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.7)" } }, "The output is a concept aid for discovery and kickoff. It is not a permit-ready drawing set, not a stamped document, and not a substitute for architect or engineer review. Gemini can support the exterior mood, but it is not the core floor-plan engine."), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-col gap-3" }, /* @__PURE__ */ React.createElement("a", { href: "/#generator", className: "cta-secondary text-center" }, "Open Live Studio"), /* @__PURE__ */ React.createElement("button", { onClick: openModal, className: "cta-hero cta-glow-soft" }, "Request Access"))))))));
};
...
const B2BWorkflowPage = () => {
  ...
  return /* @__PURE__ */ React.createElement(SubpageChrome, null, ({ openModal }) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "relative overflow-hidden", style: { background: "linear-gradient(180deg, #FFFDF9 0%, #F5EADF 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell py-16 md:py-24 relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[minmax(0,1fr)_360px] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "B2B workflow"), /* @__PURE__ */ React.createElement("h1", { className: "cg mt-6", style: { fontSize: "clamp(3rem, 7vw, 6rem)", lineHeight: 0.9, letterSpacing: "-0.06em", textTransform: "uppercase", color: "var(--ink)" } }, "A pre-meeting workflow designed for architecture firms."), /* @__PURE__ */ React.createElement("p", { className: "mt-6 max-w-3xl text-base md:text-lg leading-relaxed", style: { color: "rgba(32,26,21,0.72)" } }, "Keystone is not a generic lead form or portfolio gimmick. It is a firm-led process that helps clients arrive with structured intent so the architect can start the first serious conversation further ahead."), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-3 gap-3 mt-8 max-w-3xl" }, [
    ["Buyer", "Residential firms"],
    ["Live today", "Brief + plan + PNG + Gemini"],
    ["Rollout", "Firm-led access"]
  ].map(([label, value]) => /* @__PURE__ */ React.createElement("div", { key: label, className: "paper-panel p-4 md:p-5" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[9px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.42)" } }, label), /* @__PURE__ */ React.createElement("div", { className: "cg text-[1.4rem] mt-3 leading-[0.95]", style: { color: "var(--ink)" } }, value))))), /* @__PURE__ */ React.createElement("aside", { className: "paper-panel p-5 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "rounded-[18px] overflow-hidden" }, /* @__PURE__ */ React.createElement(SmartImage, { src: ASSETS.workflow.planReview, alt: "Architect reviewing a Keystone floor plan on screen and paper", style: { width: "100%", height: "260px", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "mt-5" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.42)" } }, "What firms get"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 mt-4" }, LIVE_NOW_FEATURES.map((item) => /* @__PURE__ */ React.createElement("div", { key: item, className: "flex items-start gap-3 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.68)" } }, /* @__PURE__ */ React.createElement("span", { className: "w-2 h-2 rounded-full mt-1.5 flex-shrink-0", style: { background: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, item))))))))), /* @__PURE__ */ React.createElement("section", { className: "py-12 md:py-16", style: { background: "var(--paper)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 xl:grid-cols-4 gap-4" }, workflowStages.map((item, index) => /* @__PURE__ */ React.createElement(motion.article, { key: item.step, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.08 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.1)", className: "h-full", style: { background: "rgba(255,255,255,0.72)", border: "1px solid rgba(255,106,55,0.1)", borderRadius: "22px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { aspectRatio: "1 / 0.82" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: item.image, alt: item.title, style: { width: "100%", height: "100%", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "p-5 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "var(--accent)", opacity: 0.78 } }, item.step), /* @__PURE__ */ React.createElement("h3", { className: "cg text-[1.6rem] mt-4 leading-[0.95]", style: { color: "var(--ink)" } }, item.title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, item.body))))))))), /* @__PURE__ */ React.createElement("section", { className: "py-12 md:py-16 relative overflow-hidden", style: { background: "linear-gradient(180deg,#0A0806 0%,#130B05 100%)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 24, color: "255,106,55", className: "opacity-18" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[minmax(0,1fr)_320px] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(255,106,55,0.72)" } }, "Why it matters"), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-6", style: { fontSize: "clamp(2.4rem, 5vw, 4.4rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "More signal before the architect spends real time."), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-2 gap-3 mt-8" }, supportGallery.map((image, index) => /* @__PURE__ */ React.createElement("div", { key: image, className: "rounded-[18px] overflow-hidden", style: { border: "1px solid rgba(255,255,255,0.08)" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: image, alt: `B2B workflow support visual ${index + 1}`, style: { width: "100%", height: "220px", objectFit: "cover", display: "block" } }))))), /* @__PURE__ */ React.createElement("div", { className: "grid gap-4" }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.14)", className: "dream-panel p-6 md:p-7" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "rgba(255,106,55,0.78)" } }, "Operator benefits"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 mt-5" }, operatorBenefits.map((item) => /* @__PURE__ */ React.createElement("div", { key: item, className: "flex items-start gap-3 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.7)" } }, /* @__PURE__ */ React.createElement("span", { className: "w-2 h-2 rounded-full mt-1.5 flex-shrink-0", style: { background: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, item))))), /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.12)", className: "paper-panel p-6 md:p-7" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "rgba(10,10,12,0.42)" } }, "Scope discipline"), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.68)" } }, "Keystone is intentionally narrow today: structured intake, generated plan, blueprint export, and optional Gemini study. CAD, estimating, scheduling, and viewer depth belong on the roadmap until they are truly live."), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-col gap-3" }, /* @__PURE__ */ React.createElement("a", { href: "/roadmap", className: "cta-secondary text-center" }, "View Roadmap"), /* @__PURE__ */ React.createElement("button", { onClick: openModal, className: "cta-hero cta-glow-soft" }, "Request Access")))))))));
};
const RoadmapPage = () => {
  ...
  return /* @__PURE__ */ React.createElement(SubpageChrome, null, ({ openModal }) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "relative overflow-hidden", style: { background: "linear-gradient(180deg, #FFFDF9 0%, #F4EBE1 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell py-16 md:py-24 relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[minmax(0,1fr)_340px] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label" }, "Roadmap"), /* @__PURE__ */ React.createElement("h1", { className: "cg mt-6", style: { fontSize: "clamp(3rem, 7vw, 6rem)", lineHeight: 0.9, letterSpacing: "-0.06em", textTransform: "uppercase", color: "var(--ink)" } }, "What Keystone does now, and what the platform is growing toward next."), /* @__PURE__ */ React.createElement("p", { className: "mt-6 max-w-3xl text-base md:text-lg leading-relaxed", style: { color: "rgba(32,26,21,0.72)" } }, "This roadmap keeps a strict line between live capability and planned capability. It shows the platform direction around estimates, elevations, 3D viewing, scheduling, and downstream export without pretending those modules are all ready today.")), /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.1)", className: "paper-panel p-6 md:p-7" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.24em]", style: { color: "rgba(10,10,12,0.42)" } }, "Product truth"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 mt-5" }, LIVE_NOW_FEATURES.map((item) => /* @__PURE__ */ React.createElement("div", { key: item, className: "flex items-start gap-3 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.68)" } }, /* @__PURE__ */ React.createElement("span", { className: "w-2 h-2 rounded-full mt-1.5 flex-shrink-0", style: { background: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, item)))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 pt-5", style: { borderTop: "1px solid rgba(10,10,12,0.08)" } }, /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, "Everything below marked ", /* @__PURE__ */ React.createElement("strong", null, "Planned"), " is direction, not a live sales claim.")))))), /* @__PURE__ */ React.createElement("section", { className: "py-12 md:py-16", style: { background: "var(--paper)" } }, /* @__PURE__ */ React.createElement("div", { className: "site-shell" }, /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 xl:grid-cols-3 gap-4" }, roadmapModules.map((module, index) => /* @__PURE__ */ React.createElement(motion.article, { key: module.title, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, amount: 0.3 }, transition: { delay: index * 0.06 } }, /* @__PURE__ */ React.createElement(TiltCard, { maxTilt: 4, style: { height: "100%" } }, /* @__PURE__ */ React.createElement(SpotlightCard, { spotlightColor: "rgba(255,106,55,0.12)", className: "h-full", style: { background: "rgba(255,255,255,0.74)", border: "1px solid rgba(255,106,55,0.1)", borderRadius: "22px", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { aspectRatio: "1 / 0.75" } }, /* @__PURE__ */ React.createElement(SmartImage, { src: module.image, alt: module.title, style: { width: "100%", height: "100%", objectFit: "cover", display: "block" } })), /* @__PURE__ */ React.createElement("div", { className: "p-5 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(10,10,12,0.42)" } }, module.phase), /* @__PURE__ */ React.createElement("span", { className: "mono text-[9px] uppercase tracking-[0.2em] px-2 py-1 rounded-full", style: {
    color: module.status === "Live" ? "white" : "rgba(10,10,12,0.56)",
    background: module.status === "Live" ? "var(--accent)" : "rgba(10,10,12,0.06)"
  } }, module.status)), /* @__PURE__ */ React.createElement("h3", { className: "cg text-[1.7rem] mt-4 leading-[0.95]", style: { color: "var(--ink)" } }, module.title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(10,10,12,0.64)" } }, module.body))))))))), /* @__PURE__ */ React.createElement("section", { className: "py-12 md:py-16 relative overflow-hidden", style: { background: "linear-gradient(180deg,#0A0806 0%,#130B05 100%)" } }, /* @__PURE__ */ React.createElement(FloatingParticles, { count: 20, color: "255,106,55", className: "opacity-16" }), /* @__PURE__ */ React.createElement("div", { className: "site-shell relative z-10" }, /* @__PURE__ */ React.createElement("div", { className: "grid xl:grid-cols-[320px_minmax(0,1fr)] gap-8 items-start" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "section-label", style: { color: "rgba(255,106,55,0.72)" } }, "Direction"), /* @__PURE__ */ React.createElement("h2", { className: "cg text-white mt-6", style: { fontSize: "clamp(2.4rem, 5vw, 4rem)", lineHeight: 0.92, letterSpacing: "-0.05em", textTransform: "uppercase" } }, "The platform grows outward from plan logic.")), /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 gap-4" }, roadmapTracks.map(([title, body]) => /* @__PURE__ */ React.createElement(SpotlightCard, { key: title, spotlightColor: "rgba(255,106,55,0.14)", className: "dream-panel p-5 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mono text-[10px] uppercase tracking-[0.22em]", style: { color: "rgba(255,106,55,0.78)" } }, title), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm leading-relaxed", style: { color: "rgba(244,239,230,0.68)" } }, body))))), /* @__PURE__ */ React.createElement("div", { className: "mt-8 flex flex-col sm:flex-row gap-3" }, /* @__PURE__ */ React.createElement("a", { href: "/b2b-workflow", className: "cta-secondary text-center" }, "View B2B Workflow"), /* @__PURE__ */ React.createElement("button", { onClick: openModal, className: "cta-hero cta-glow-soft" }, "Request Access"))))));
};
const FAQPage = () => {
